 ...
 */
class AccessUrl extends \Chamilo\CoreBundle\Entity\AccessUrl implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'course', 'url', 'description', 'active', 'createdBy', 'tms', 'urlType', 'sessionCategory'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AccessUrl $proxy) {
