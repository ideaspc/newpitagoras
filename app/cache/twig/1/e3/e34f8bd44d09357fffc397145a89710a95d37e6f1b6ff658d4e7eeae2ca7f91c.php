...
class __TwigTemplate_925380e14b22ce2bedcb05a57ecd266d030059d77accdde88e6b101f00793c79 extends \Twig\Template
{
...
var connect_lang = '";
        // line 5
        echo twig_escape_filter($this->env, get_lang("ChatConnected"), "js");
        echo "';
var disconnect_lang = '";
        // line 6
        echo twig_escape_filter($this->env, get_lang("ChatDisconnected"), "js");
        echo "';
var chatLang = '";
        // line 7
        echo twig_escape_filter($this->env, get_lang("GlobalChat"), "js");
        echo "';
...
";
        ...
        if (api_get_configuration_value("hide_chat_video")) {
            // line 10
            echo "    var hide_chat_video = true;
";
        } else {
            // line 12
            echo "    var hide_chat_video = false;
";
        }
        // line 14
        echo "
\$(function() {
    ...
    \$('#confirm-delete').on('show.bs.modal', function(e) {
        ...
        var message = '";
        // line 111
        echo twig_escape_filter($this->env, get_lang("AreYouSureToDeleteJS"), "js");
    ...
    if ( ";
        ...
        echo "'],
            success: function(mediaElement, originalNode, instance) {
                ";
        // line 271
        echo ($context["quiz_markers_rolls_js"] ?? null);
        echo "
            },
        ...
        \$.ajax({
            ...
            success: function(data) {
                ...
                if (data == 'added') {
                    //\$('#vote_label2_' + id).html(\"";
        // line 315
        echo twig_escape_filter($this->env, get_lang("Saved"), "js");
        echo "\");
                }
                if (data == 'updated') {
                    //\$('#vote_label2_' + id).html(\"";
    ...
    function socialLikes() {
        ...
        if (api_get_configuration_value("social_enable_messages_feedback")) {
            // line 330
            echo "        \$('body').on('click', '.social-like', function (e) {
            e.preventDefault();
...
function action_click(element, table_id) {
    ...
    if (!confirm('";
        // line 488
        echo twig_escape_filter($this->env, get_lang("ConfirmYourChoice"), "js");
        echo "')) {
        return false;
    } else {
...
";
    ...
    {
        return array (  684 => 581,  588 => 488,  477 => 379,  434 => 339,  423 => 330,  421 => 329,  407 => 318,  401 => 315,  392 => 309,  377 => 297,  373 => 296,  345 => 271,  340 => 269,  333 => 265,  275 => 210,  271 => 209,  267 => 208,  245 => 189,  241 => 188,  237 => 187,  158 => 111,  59 => 14,  55 => 12,  51 => 10,  49 => 9,  44 => 7,  40 => 6,  36 => 5,  30 => 1,);
    }
    ...
    {
        return new Source("", "default/layout/main.js.tpl", "/home4/mdmaster/public_html/www/nuevopitagoras.com/main/template/default/layout/main.js.tpl");
    }
}
