...
/* default/skill/skill_wheel.js.tpl */
class __TwigTemplate_1ccd6668d376432712e44dd5cbf9491a17a8de6d3effd5ac9135375ffa7030ae extends \Twig\Template
{
    ...
    {
        // line 2
        $this->loadTemplate(api_find_template("layout/topbar.tpl"), "default/skill/skill_wheel.js.tpl", 2)->display($context);
        // line 3
        echo "<script>
...
var url = '";
        ...
        echo ($context["url"] ?? null);
        echo "';
var skill_to_load_from_get = '";
        // line 64
        echo ($context["skill_id_to_load"] ?? null);
        echo "';
...
function load_nodes(load_skill_id, main_depth, extra_parent_id) {
    ...
    d3.json(\"";
        // line 505
        echo ($context["wheel_url"] ?? null);
        echo "&main_depth=\"+main_depth+\"&\"+load_skill_condition, function(json) {
...
";
    ...
    {
        return "default/skill/skill_wheel.js.tpl";
    }
    ...
    {
        return array (  548 => 505,  503 => 463,  101 => 64,  97 => 63,  40 => 9,  32 => 3,  30 => 2,);
    }
    ...
    {
        return new Source("", "default/skill/skill_wheel.js.tpl", "/home4/mdmaster/public_html/www/nuevopitagoras.com/main/template/default/skill/skill_wheel.js.tpl");
    }
}
